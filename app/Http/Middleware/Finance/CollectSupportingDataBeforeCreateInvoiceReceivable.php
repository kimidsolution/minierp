...
class CollectSupportingDataBeforeCreateInvoiceReceivable
{
    /**
    ...
    public function handle($request, Closure $next)
    {
        ...
        //? collect data partner for type customer & both
        ...
        $dataPartners = ($partners->count() > 0) ? $partners->pluck('partner_name', 'id')->toArray() : [];
        ...
        $assetAccountIds = $assetAccounts->pluck('account_name', 'id')->toArray();
        ...
        $request->request->add([
            'data_collect_for_invoice_receivable' => [
