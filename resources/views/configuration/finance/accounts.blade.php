...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Finance Configuration Accounts</h4>
            </div>
        </div>
        <!-- end col-->
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <input type="hidden" id="routeFetch" value="{{ route('api.datatable.configuration.finance.accounts.route') }}">
                <input type="hidden" id="routeDelete" value="{{ route('api.configuration.finance.destroy.route') }}">
                ...
                <div class="card-body">
                    <div class="button-items mb-4 ml-6">
                        <a href="{{ route('configuration.finance.accounts.create') }}"
                            class="btn btn-primary waves-effect waves-light"
                        >
                            Add Configuration <i class="far fa-plus-square ml-1"></i>
                        </a>
                        @if ($isAdmin)
                    ...
                    <div class="table-responsive">
                        <table id="configuration-datatable" class="table table-striped table-sm table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                <tr>
                                    <th>Company</th>
                                    <th>Description</th>
...
<script src="{{ URL::asset('pages/js/configuration/finance/accounts.js') }}"></script>
