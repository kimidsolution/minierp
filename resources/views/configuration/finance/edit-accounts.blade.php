    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit Finance Configuration Accounts</h4>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <input type="hidden" id="routeFetchLoad" value="{{ route('api.configuration.finance.load.route') }}">

                    <form class="form-parsley" id="jq-validation-form-create">
                        <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                        <input type="hidden" id="companyId" name="company_id" value="{{ $configuration->company_id }}">
                        <input type="hidden" id="idConfiguration" name="configuration_id" value="{{ $configuration->id }}">
                        <input type="hidden" id="configCodeValue" name="config_code_value" value="{{ $configuration->configuration_code }}">
                        <div class="form-row">
                            <div class="col-md-12">
                                    ...
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons" style="display: block;">
                                        <label class="btn btn-outline-primary btn-sm">
                                            <input type="radio"
                                                value="true"
                                                name="config_status"
                                                {{ $configuration->configuration_status == true ? 'checked' : '' }}
                                            >
                                            Active
                                        </label>
                                        <label class="btn btn-outline-primary btn-sm">
                                            <input type="radio"
                                                value="false"
                                                name="config_status"
                                                {{ $configuration->configuration_status == false ? 'checked' : '' }}
                                            >
                                            Not Active
                                        </label>
                                    </div>
