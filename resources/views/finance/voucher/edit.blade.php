                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="company_id" id="company_id" class="select2 form-control select-company" required>
                                        ...
                                        @foreach ($list_company as $company_detail)
                                            <option value="{{ $company_detail->id }}" {{ $voucher->company_id == $company_detail->id ? 'selected' : ''}}>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::text('voucher_number', $voucher->voucher_number, ['class' => 'form-control', 'id' => 'voucher_number', 'name' => 'voucher_number', 'readonly' => true]) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control" type="text" value="{{ date('d-m-Y', strtotime($voucher->voucher_date)) }}" id="tanggal" name="tanggal" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-5">
                                <label class="label-required">Additional Notes</label>
                                <input class="form-control" type="text" id="deskripsi" name="deskripsi" value="{{ old('deskripsi', $voucher->note) }}">
                            </div>
                        </div>
                    </div><!--end card-body-->
                </div><!--end card-->
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mt-5">
                            <button type="submit" id="submitForm" class="btn btn-gradient-primary waves-effect waves-light btn-submit btn-save">
                                Update
                            </button>
                            ...
                            <input type="hidden" id="routeStoreVoucher" value="{{ route('api.finance.voucher.update.route') }}">
                            <input type="hidden" id="routeListVoucherInvoiceEdit" value="{{ route('api.finance.voucher.get.list.invoice.by.id.route') }}">
                            ...
                            <input type="hidden" id="voucherJson" value="{{ $voucher_json }}">
...
@section('script')
    ...
    <script src="{{ URL::asset('pages/js/voucher/formEdit.js') }}"></script>
@endsection
