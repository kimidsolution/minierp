                ...
                <div class="card-body">
                    @if ($isAdmin)
                        <div class="button-items mb-4 ml-6">
                            <a href="{{ route('finance.vouchers.create') }}" class="btn btn-primary waves-effect waves-light">
                                Create Voucher <i class="far fa-plus-square ml-1"></i>
                            </a>
                            <button id="show-all" class="btn btn-primary items-hide" data-toggle="tooltip" data-placement="left"
                                title="Show All Voucher" data-id="false">
                                Show All
                            </button>
                            <button id="show-active" class="btn btn-primary items-hide" data-toggle="tooltip" data-placement="left"
                                title="Show Voucher Active" data-id="true">
                                Show Active
                            </button>
                            <div class="scope-action-table-dropdown">
                                <div class="form-group row">
                                    <label for="filter-company" class="col-sm-6 col-form-label text-right">Voucher Of Company</label>
                                    <div class="col-sm-6">
                    ...
                    <div class="table-responsive">
                        <table id="voucher-datatable" class="table table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                <tr>
                                    <th>Partner</th>
...
<script src="{{ URL::asset('pages/js/voucher/index.js') }}"></script>
