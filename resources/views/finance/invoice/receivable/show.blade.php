            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Detail Invoice Receivable</li>
                    </ol>
                </div>
                <h4 class="page-title">Invoice Receivable</h4>
                    ...
                    <div class="row d-flex">
                        <div class="col-lg-12 col-xl-4">
                            <div class="d-print-none">
                                <a href="{{ route('finance.invoices.receivable.index') }}" class="btn btn-gradient-danger">Back</a>
                                @if (2 == $invoice->is_posted)
                                <a href="{{ route('finance.invoices.receivable.posted', ['id' => $invoice->id]) }}" class="btn btn-gradient-primary">Posted</a>
                                <a href="{{ route('finance.invoices.receivable.edit', ['receivable' => $invoice->id]) }}" class="btn btn-gradient-success">Edit Invoice</a>
                                @endif
                            </div>
                        </div>
                    </div>
