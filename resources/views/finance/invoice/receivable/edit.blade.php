                    ...
                    <form class="form-parsley" id="myForm" action="#">
                        ...
                        <div class="form-row">
                            @if ($isAdmin)
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="company_id" id="company_id" class="select2 form-control select-company" required>
                                        <option value=""> Choose Company ... </option>
                                        @foreach ($list_company as $company_detail)
                                            <option value="{{ $company_detail->id }}" {{ $invoice->company_id == $company_detail->id ? 'selected' : ''}}>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::select('partner_id', [], null, ['placeholder' => 'Select Partner', 'class' => 'select2 form-control mb-3 custom-select', 'id' => 'pelanggan', 'name' => 'pelanggan', 'style' => 'width: 100%; height:36px;']) !!}
                            </div>
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::text('invoice_number', $invoice->invoice_number, ['class' => 'form-control', 'id' => 'noref', 'name' => 'noref', 'readonly' => true]) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input class="form-control" type="text" value="{{ date('d-m-Y', strtotime($invoice->invoice_date)) }}" id="tanggal" name="tanggal">
                            </div>
                            <div class="form-group col-md-2">
                                <label class="label-required">Due Date</label>
                                <input class="form-control" type="text" value="{{ date('d-m-Y', strtotime($invoice->due_date)) }}" id="duedate" name="duedate">
                            </div>
                            <div class="form-group col-md-2">
                                ...
                                <div class="input-group">
                                    {!! Form::select(
                                        ...
                                        app('string.helper')->countRangeDate($invoice->invoice_date, $invoice->due_date),
                                        ['placeholder' => 'Select', 'class' => 'form-control mb-3 custom-select change-term', 'id' => 'payment_term', 'name' => 'payment_term', 'style' => 'width: 100%; height:36px;']
                                    ) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" value="{{ old('deskripsi', $invoice->note) }}" type="text" id="deskripsi" name="deskripsi">
                            </div>
                        </div>
                        <div class="form-row mb-2">
                            <table class="table table-bordered mb-0 table-centered">
                                ...
                                <tbody id="transactions_table">
                                        <tr>
                                            <td>
                                                <select class="select2 form-control getproduct" style="width: 100%;" id="product-0" ids="'+counter+'" name="product[]">
                                                </select>
                                            </td>
                                            <td>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="diskon" class="col-sm-4 col-form-label text-left">Discount ( - ) %</label>
                                    <div class="col-sm-8">
                                        <div class="form-row">
                                            <div class="col-md-3"><input class="form-control only-number" type="text" value="0" name="diskonpersen" id="diskon-persen"></div>
                                            <div class="col-md-9"><input class="form-control" type="text" value="0" id="diskon-harga" name="diskonharga" style="text-align: right;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" type="text" value="0" id="harga-pajak" name="hargapajak" style="text-align: right;" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="total" class="col-sm-4 col-form-label text-left">Total Invoice</label>
                                    <div class="col-sm-8">
                        ...
                        <div class="form-group mt-5">
                            <button type="submit" id="updateInvoice" class="btn btn-gradient-primary waves-effect waves-light btn-submit btn-save">
                                Update
                            </button>
                            <a href="{{ route('finance.invoices.receivable.index') }}"><button type="button" class="btn btn-gradient-danger waves-effect m-l-5">
                                Cancel
                            </button></a>
                            ...
                            <input type="hidden" id="routeListPartnerCustomerBothCompany" value="{{ route('api.select2.get.list.partner.customer.both.route') }}">
                            ...
                            <input type="hidden" id="routeStoreInvoiceReceivable" value="{{ route('api.finance.invoice.receivable.update.route') }}">
                            <input type="hidden" id="routeStoreProduct" value="{{ route('api.product.store.route') }}">
                            <input type="hidden" id="routeShowInvoice" value="{{ route('finance.invoices.receivable.show', ['receivable' => ':id']) }}">
                            <input type="hidden" id="routeCompanyDetail" value="{{ route('api.company.detail.route') }}">

                            <input type="hidden" id="companyID" value="{{ ($isAdmin) ? $company->id : Auth::user()->company_id }}">
                            <input type="hidden" id="userId" value="{{ Auth::user()->id }}">
                            <input type="hidden" id="adminStatus" value="{{ $isAdmin }}">
                            <input type="hidden" id="vatEnabledCompany" value="{{ $company->vat_enabled }}">

                            <input type="hidden" id="invoiceJson" value="{{ $invoice_json }}">
                            <input type="hidden" id="taxJson" value="{{ $inv_tax_json }}">
                            ...
                            <input type="hidden"
                                ...
                                value="{{ App\Models\FinanceConfiguration::CODE_ACCOUNT_DP_INVOICE_RECEIVABLE }}"
                            >
                        </div><!--end form-group-->
                    </form><!--end form-->
                </div><!--end card-body-->
...
@include('finance.invoice.receivable.partials.modal_add_product')
...
@section('script')
    ...
    <script src="{{ URL::asset('pages/js/invoice/receivable/formEdit.js') }}"></script>
@endsection
