                ...
                <div class="card-body">
                    @if ($isAdmin)
                        <div class="button-items mb-4 ml-6">
                            <a href="{{ route('finance.invoices.receivable.create') }}" class="btn btn-primary waves-effect waves-light">
                                Create Customer Invoice<i class="far fa-plus-square ml-1"></i>
                            </a>
