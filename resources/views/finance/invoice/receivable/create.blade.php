    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Create Customer Invoice</h4>
                ...
                <div class="card-body">
                    ...
                    <form class="form-parsley" id="myForm" action="#">
                        ...
                        <div class="form-group mt-5">
                            ...
                            <input type="hidden" id="routeStoreInvoiceReceivable" value="{{ route('api.finance.invoice.receivable.store.route') }}">
...
@section('script')
    ...
    <script src="{{ URL::asset('pages/js/invoice/receivable/formInput.js') }}"></script>
@endsection
