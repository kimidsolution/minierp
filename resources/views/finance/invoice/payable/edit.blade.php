            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Invoice Payable</li>
                    </ol>
                </div>
                <h4 class="page-title">Edit Invoice Payable</h4>
                    ...
                    <form class="form-parsley" id="myForm" action="#">
                        ...
                        <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="company_id" id="company_id" class="select2 form-control select-company" required>
                                        ...
                                        @foreach ($list_company as $company)
                                            <option value="{{ $company->id }}" {{ $data_invoice->company_id == $company->id ? 'selected' : ''}}>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::text('invoice_number', $data_invoice->invoice_number, ['class' => 'form-control', 'id' => 'noref', 'name' => 'noref', 'readonly' => 'true']) !!}
                            </div>
                            <div class="form-group col-md-3">
                                <label class="label">Purchase Order</label>
                                <input class="form-control" type="text" value="{{ $data_invoice->purchase_order }}" id="purchase_order" name="purchase_order" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input class="form-control" type="text" value="{{ date('d-m-Y', strtotime($data_invoice->invoice_date)) }}" id="tanggal" name="tanggal" autocomplete="off">
                            </div>
                            <div class="form-group col-md-2">
                                <label class="label-required">Due Date</label>
                                <input class="form-control" type="text" value="{{ date('d-m-Y', strtotime($data_invoice->due_date)) }}" id="duedate" name="duedate" autocomplete="off">
                            </div>
                            <div class="form-group col-md-2">
                                <label class="label">Payment Term</label>
                                <div class="input-group">
                                    {!! Form::select('payment_term', [14 => '14 days', 30 => '30 days'], app('string.helper')->countRangeDate($data_invoice->invoice_date, $data_invoice->due_date), ['placeholder' => 'Select', 'class' => 'form-control mb-3 custom-select change-term', 'id' => 'payment_term', 'name' => 'payment_term', 'style' => 'width: 100%; height:36px;']) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" id="deskripsi" name="deskripsi" value="{{ $data_invoice->note }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-5">
                            ...
                            <input type="hidden" id="routeUpdateInvoicePayable" value="{{ route('api.finance.invoice.payable.update.route') }}">
                            ...
                            <input type="hidden" id="companyID" value="{{ ($isAdmin) ? $data_company->id : Auth::user()->company_id }}">
...
@section('script')
    ...
    <script src="{{ URL::asset('pages/js/invoice/payable/formEdit.js') }}"></script>
@endsection
