                    ...
                    <form class="form-parsley" id="myForm" action="#">
                        ...
                        <div class="form-row mb-3">
                            <div class="col-md-4 mb-3">
                                ...
                                {!! Form::select('partner_id', $data_partner, $invoice->partner_id, ['placeholder' => 'Select Customer...', 'class' => 'select2 form-control mb-3 custom-select', 'id' => 'pelanggan', 'name' => 'pelanggan', 'style' => 'width: 100%; height:36px;']) !!}
                            </div>
                            <div class="col-md-2 mb-3 ml-3 choice-payment">
                                <label>Pilih Akun (Aset)</label>
                                {!! Form::select('account_id', $data_aset_accounts, $invoice->payment_method, ['class' => 'select2 form-control mb-3 custom-select', 'id' => 'akun', 'name' => 'akun', 'style' => 'width: 100%; height:36px;']) !!}
                            </div>
                            <div class="col-md-2 mb-3 ml-3">
                                <div class="form-check-inline my-4">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="ispurchase" id="ispurchase" data-parsley-multiple="groups" data-parsley-mincheck="2" value="purchase" {{ ($invoice->type == "purchase") ? 'checked' : '' }}>
                        ...
                        <div class="form-row mb-3">
                            <div class="col-md-2 mb-3">
                                ...
                                <input class="form-control" type="date" value="{{ date('Y-m-d', strtotime($invoice->date)) }}" id="tanggal" name="tanggal">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label for="validationServer01">Jatuh Tempo</label>
                                <input class="form-control" type="date" value="{{ date('Y-m-d', strtotime($invoice->due_date)) }}" id="duedate" name="duedate">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="validationServer01">No. Referensi</label>
                                {!! Form::text('invoice_number', $invoice->number, ['class' => 'form-control', 'placeholder' => 'Masukkan no referensi', 'id' => 'noref', 'name' => 'noref', 'readonly']) !!}
                            </div>
                            <div class="col-md-5 mb-3">
                                <label for="validationServer01">Deskripsi</label>
                                <input class="form-control" type="text" placeholder="Masukkan no deskripsi" id="deskripsi" name="deskripsi" value="{{ $invoice->note }}">
                            ...
                            <table class="table table-bordered mb-0 table-centered">
                                ...
                                <tbody id="transactions_table">
                                    ...
                                    @foreach ($detail_invoice as $detail)
                                        <tr>
                                            <td>
                                                {!! Form::select('product', $data_products_db, $detail->product_id, ['class' => 'select2 form-control getproduct', 'id' => 'product-' . $no, 'name' => 'product[]']) !!}
                                            </td>
                                            <td>
                                                <input class="form-control changeqty only-number" type="text" id="qty-{{ $no }}" name="qty[]" value="{{ $detail->qty }}" style="text-align: right;">
                                            </td>
                                            <td>
                                                <input class="form-control" type="text" id="harga-{{ $no }}" name="harga[]" value="{{ app('string.helper')->defFormatCurrency($detail->basic_price, "Rp ") }}" style="text-align: right;" readonly>
                                            </td>
                                            <td>
                                                <input class="form-control totalproduct" type="text" id="total-{{ $no }}" name="total[]" value="{{ app('string.helper')->defFormatCurrency($detail->total_price, "Rp ") }}" style="text-align: right;" readonly>
                                            </td>
                                            <td>
                                                <div class="dropdown d-inline-block float-right">
                                                    <button type="button" id="btn-add-{{ $no }}" class="btn btn-sm btn-gradient-primary waves-effect waves-light my-button-add" title="klik untuk tambah" onclick="addRow()"><i class="fas fa-plus"></i></button> &nbsp;
                                                    <button type="button" id="btn-del-{{ $no }}" class="btn btn-sm btn-gradient-danger waves-effect waves-light my-button-delete" onclick="delRow(this)" title="klik untuk hapus"><i class="far fa-trash-alt ml-1"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php $no++; ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" type="text" value="{{ app('string.helper')->defFormatCurrency($invoice->amount, "Rp ") }}" id="total-totalbarangjasa" name="totalbarangjasa" style="text-align: right;" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-row">
                                            <div class="col-md-3"><input class="form-control only-number" type="text" value="{{ app('string.helper')->getDiscountPersent($invoice->amount, $invoice->discount) }}" name="diskonpersen" id="diskon-persen"></div>
                                            <div class="col-md-9"><input class="form-control" type="text" value="{{ app('string.helper')->defFormatCurrency($invoice->discount, "Rp ") }}" id="diskon-harga" name="diskonharga" style="text-align: right;" readonly></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-row">
                                            <div class="col-md-3">
                                                {!! Form::select('ppn', ['' => 'Pilih', '10' => 'PPN'], ($invoice->total_tax <> 0) ? '10' : '', ['class' => 'form-control custom-select', 'id' => 'ppn', 'name' => 'ppn', 'style' => 'width: 100%; height:36px;']) !!}
                                            </div>
                                            <div class="col-md-9"><input class="form-control" type="text" value="{{ app('string.helper')->defFormatCurrency($invoice->total_tax, "Rp ") }}" id="harga-pajak" name="hargapajak" style="text-align: right;" readonly></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" type="text" value="{{ app('string.helper')->defFormatCurrency($invoice->down_payment + $invoice->final_amount, "Rp ") }}" id="subtotal" name="subtotal" style="text-align: right;" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control only-number auto-currency" type="text" value="{{ $invoice->down_payment }}" id="uangmuka" style="text-align: right;" name="uangmuka" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" type="text" value="{{ app('string.helper')->defFormatCurrency($invoice->final_amount, "Rp ") }}" name="sisanominal" id="sisauang" style="text-align: right;" readonly>
                        ...
                        <div class="form-group mt-5">
                            <button type="submit" class="btn btn-gradient-primary waves-effect waves-light btn-submit btn-save">
                                Update
                            </button>
    ...
    <script>
        ...
        $(document).ready(function(e){
            ...
            $(".btn-submit").click(function(e){
                ...
                var v_invoice_id = $("#invoice_id").val();
                ...
                if (dataPost.partner_id == "") {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ route('api.finance.invoice.update.route') }}',
                        data: dataPost,
                        success:function(data){

                            if (data == 'ok') {
                                var message = 'Invoice Berhasil Diupdate';
                                var type = 'success';
                                var title = 'Berhasil';
                            } else {
        ...
        function calcUangMuka() {
            ...
            if (uangMuka.length > 0) {
                var sisauang = parseInt(parseCurrency(subtotal)) - parseInt(parseCurrency(uangMuka));
