<!-- Expense -->
@if (!empty($request->resource_expense))
    @foreach ($request->resource_expense as $expense)
        <tr class="header-title-row" style="cursor: pointer;" data-toggle="collapse" data-target="#expenseCollapse">
        ...
        <tr id="expenseCollapse" class="collapse">
                                ...
                                @if (!empty($account_expense['account_children']))
                                    @foreach ($account_expense['account_children'] as $child_expense)
                                        ...
                                        @if (!empty($childrens->toArray()))
                                            @include('finance.report.profit-loss.partials.expense.expense_childrens', [
    ...
    <tr>
        <td class="text-left" style="padding: 10px 10px 10px 0px; color: rgb(80,179,128); font-size: 0.8rem;">
            <b style="margin-left: 16px;">Total Expenses</b>
        </td>
