<!-- Other Income -->
@if (!empty($request->resource_other_income))
    @foreach ($request->resource_other_income as $income)
        <tr class="header-title-row" style="cursor: pointer;" data-toggle="collapse" data-target="#otherIncomeCollapse">
        ...
        <tr id="otherIncomeCollapse" class="collapse">
                                    ...
                                    @foreach ($account_income['account_children'] as $child_revenue)
                                        ...
                                        @if ($account_nominal_credit > 0)
                                            <tr data-id="{{ $child_revenue['id'] }}" data-parent="0" data-level="1" style="font-size: 0.8rem;">
                                                ...
                                                <td data-column="currency" class="text-right" style="color: #425176;">
                                        ...
                                        @if (!empty($childrens->toArray()))
                                            @include('finance.report.profit-loss.partials.other_income.other_income_childrens', [
    ...
    <tr>
        <td class="text-left" style="padding: 10px 10px 10px 0px; color: rgb(80,179,128); font-size: 0.8rem;">
            <b style="margin-left: 16px;">Total Other Income</b>
        </td>
