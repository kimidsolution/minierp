...
<div class="container-fluid">
    ...
    <div class="row">
        <input type="hidden" id="routeFetch" value="{{ route('api.finance.report.profit.loss.route') }}">
        ...
        <div class="col-12">
            <div class="card">
                @if ($isAdmin)
                    <div class="card-header header-report-company">
                        <div class="scope-action-table-dropdown">
                            <div class="row">
                                <label for="filter-company" class="col-sm-6 col-form-label text-right">Profit And Loss Of Company</label>
                                <div class="col-sm-6">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive row-table-sticky mb-0" style="padding-left: 15px; padding-right: 15px;" id="row-table-expand">
                        ...
                        <table class="table table-sticky" id="profit-loss-table">
                            <thead>
                                <tr style="background-color: #50b380;">
                                    <th class="text-left" style="color: #fff; border-bottom: 0.5px solid;">ACCOUNT NAME</th>
                                    <th class="text-right" style="padding-left: 100px; color: #fff; border-bottom: 0.5px solid;">AMOUNT</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script src="{{ URL::asset('pages/js/report/profit-loss/index.js') }}"></script>
@endsection
