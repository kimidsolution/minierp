    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit Transaction {{ $title_transaction }}</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <input type="hidden" id="routeFetchDetails" value="{{ route('api.finance.transaction.load.route') }}">
                    <input type="hidden" id="valueReferenceNumber" value="{{ $transaction->reference_number }}">
                    <form class="form-parsley" id="jq-validation-form-create">
                        ...
                        <input type="hidden" id="companyId" name="company_id" value="{{ $transaction->company_id }}">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select id="modelType" name="model_type" class="select2 form-control" required>
                                    ...
                                    @foreach ($list_model_type as $type)
                                        <option data-id="{{ $type['id'] }}" value="{{ $type['id'] }}" {{ $value_model_type == $type['id'] ? 'selected' : '' }}>
                                            {{ $type['name'] }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control"
                                    ...
                                    autocomplete="off"
                                    value="{{ old('transaction_date', date("d-m-Y", strtotime($transaction->transaction_date))) }}"
                                >
                            </div>
                            <div class="form-group col-md-3" id="divReferenceNumber">
                                <label>Reference Number</label>
                                <input class="form-control" type="text" value="{{ old('reference_number', $transaction->reference_number) }}" id="refrenceNumber" name="reference_number">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="description" id="description" class="form-control" rows="2">{{old('description', $transaction->description)}}</textarea>
                            </div>
                        </div>
