...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Transactions Import</h4>
            </div>
        </div>
        <!-- end col-->
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <input type="hidden" id="routeFetch" value="{{ route('api.datatable.transactions.import.route') }}">
                ...
                <div class="card-body">
                    <div class="button-items mb-4 ml-6">
                        @if ($isAdmin)
                            <a href="{{ route('finance.transactions.import.upload.view') }}" class="btn btn-primary waves-effect waves-light">
                                Upload Transactions<i class="far fa-plus-square ml-1"></i>
                            </a>
                            <div class="scope-action-table-dropdown">
                                <div class="form-group row">
                                    <label for="filter-company" class="col-sm-6 col-form-label text-right">Transactions Of Company</label>
                                    <div class="col-sm-6">
...
<script src="{{ URL::asset('pages/js/transaction/index-import.js') }}"></script>
