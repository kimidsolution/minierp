    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <input type="hidden" id="routeDelete" value="{{ route('api.partner.destroy.route') }}">
                <input type="hidden" id="userId" value="{{ Auth::user()->id }}">
                <input type="hidden" id="isAdmin" value="{{ $isAdmin }}">
                <input type="hidden" id="companyId" value="{{ Auth::user()->company_id }}">
                <div class="card-body">
                    <div class="button-items mb-4 ml-6">
                        <a href="{{ route('master.partner.create') }}" class="btn btn-primary waves-effect waves-light">
                            Create Partner <i class="far fa-plus-square ml-1"></i>
                        </a>
                        @if ($isAdmin)
                    ...
                    <div class="table-responsive">
                        <table id="partner-datatable" class="table table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                <tr>
                                    <th>Partner Name</th>
                                    <th>Type</th>
...
<script src="{{ URL::asset('pages/js/partner/index.js') }}"></script>
